...
Copyright (c) 2026 Ryan P. Walsh. All rights reserved. This proprietary codebase is published solely for public viewing and professional reference; it is not open source and no permission is granted to use, copy, modify, distribute, sell, deploy, or create derivative works. See [LICENSE](LICENSE). Third-party components retain their own licenses.
